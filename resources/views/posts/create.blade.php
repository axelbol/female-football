<x-layouts.app :title="__('Create Post')">
    <div class="flex h-full w-full flex-1 flex-col gap-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">{{ __('Create Post') }}</h1>
                <p class="text-sm text-gray-600 dark:text-gray-400">{{ __('Write a new blog post') }}</p>
            </div>
